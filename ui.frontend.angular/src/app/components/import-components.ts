 ...
 */
MapTo('siteA/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('siteA/components/separator')(SeparatorV1Component);

MapTo('siteA/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('siteA/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('siteA/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('siteA/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('siteA/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('siteA/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('siteA/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('siteA/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('siteA/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('siteA/components/accordion')(AccordionV1Component);
MapTo('siteA/components/tabs')(TabsV1Component);
...
LazyMapTo('siteA/components/teaser')(TeaserV1Component);
...
LazyMapTo('siteA/components/carousel')(CarouselV1Component);
...
LazyMapTo('siteA/components/text')(LazyTextModule, TextEditConfig);